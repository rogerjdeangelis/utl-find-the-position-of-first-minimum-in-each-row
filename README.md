# utl-find-the-position-of-first-minimum-in-each-row
Find the position of first minimum in each row 
    ...
    */
    ...
    INFO: Data file SD1.WANT_R.DATA is in a format that is native to another host, or the file encoding does not match the session encoding. Cross Environment Data Ac
